  ...
  return (
    <>
      ...
      <motion.div
        ...
        animate={{ x: 0 }}
        exit={{ opacity: 100 }}
        transition={{ duration: 0.4, ease: "linear" }} className="overflow-hidden w-full bg-gradient-to-b from-[#F5F5DC] bg-cover min-h-screen z-50 fixed top-0 lg:relative flex flex-col gap-2  items-center justify-center pt-0 ">
