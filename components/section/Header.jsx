    ...
    <>
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full animates min-h-screen absolute top-0  "
        >
          <Image
        ...
        <div className="w-full h-screen bg-gradient-to-t from-black  via-stone-700/50  to-black absolute top-0 z-10"></div>
